...
public class FunctionalActivity {
    ...
    public static void main(String[] args) {
        ...
        PowerUp speedBoost = (h, s) -> h > 50 ? s * 2: s;
        ...
        List<Enemy> strongEnemies = filterEnemies(
                enemies,
        ...
        List<Enemy> weakEnemies = filterEnemies(
                enemies,
                enemy -> enemy.damage < 15);
        ...
        List<String> taggedNames = transformAll(playerNames, "[LVL 1] %s"::formatted);
